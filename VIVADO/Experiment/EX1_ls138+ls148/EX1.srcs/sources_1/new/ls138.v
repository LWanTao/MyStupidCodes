...
//////////////////////////////////////////////////////////
module ls138(a,b,c,d0,d1,d2,d3,d4,d5,d6,d7,S1,S2,S3,clr);
input a,b,c,S1,S2,S3,clr;
output reg d0,d1,d2,d3,d4,d5,d6,d7;
always @(S1,S2,S3,a,b,c,clr)
begin
    if(clr) {d0,d1,d2,d3,d4,d5,d6,d7}=8'b11111111;
        else if(S1 && (!(S2 + S3)))
        begin
        case({a,b,c})
        ...
        endcase end
        else begin {d0,d1,d2,d3,d4,d5,d6,d7}=8'b11111111;end end
endmodule